...
<div className="inline-flex items-center gap-3  py-3  backdrop-blur-md 
              ...
              <p className="text-lg text-zinc-400 leading-relaxed">
                Showcase your products in a whole new way with our Interactive Product Apps. We design and develop engaging, 3D-enabled applications that let users explore, customize, and experience your products virtually — from every angle and in real time
              </p>

              <p className="text-lg text-zinc-400 leading-relaxed">
                Perfect for marketing, sales, exhibitions, and e-commerce, our interactive apps blend creativity with technology to deliver immersive product experiences. Whether it’s a realistic 3D model, AR-based visualization, or a virtual demo, we help your brand stand out with innovation and interactivity
              </p>
              <p>
                Turn your products into digital experiences that attract attention, drive engagement, and boost customer confidence.
              </p>
            </div>
...
<div className="product-apps-video relative group w-full max-w-5xl mx-auto px-4 lg:-mt-40">
  ...
  {/* Modern Glow Effect: Matches the Interactive/App theme with pink-violet */}
  ...
  <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl bg-black border border-white/10">
    <video
      ...
      src='https://res.cloudinary.com/dq3ubcgdd/video/upload/v1764439050/Interactive_Product_Apps_-_Multi_Loop_vdymn7.mp4'
      muted={isMuted}
      autoPlay
      loop
      playsInline
    ...
    {/* <div className="absolute bottom-6 left-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
        <span className="text-white/60 text-[10px] uppercase tracking-[0.2em] font-bold">Interactive App Interface</span>
    </div> */}
  </div>
