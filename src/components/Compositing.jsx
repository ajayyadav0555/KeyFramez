                ...
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center py-20">
                 ...
                 bg-gradient-to-r from-blue-400 to-pink-500">
                            ...
                            <p className="text-lg text-zinc-400 leading-relaxed">
                                Seamlessly blend imagination with reality through our Compositing and Green Screen Integration services. We specialize in merging live-action footage with CGI elements, matte paintings, and dynamic environments to create visually stunning, believable scenes.
                            </p>

                            <p className="text-lg text-zinc-400 leading-relaxed">
                                Our skilled compositors use advanced tools and precise color matching, lighting, and layering techniques to ensure perfect integration — whether it’s keying, background replacement, set extension, or visual enhancements.
                            </p>
                            <p className="text-lg text-zinc-400 leading-relaxed">
