...
const Navbar = () => {
    ...
    const services = [
        ...
        },
        {
            ...
            name: "Ai Based Animation",
            path: "/services/aibasedanimation",
            description: "Stunning visual effects and compositing"
        },
        {
            icon: <Megaphone size={18} />,
            name: "Motivational AV's",
    ...
    return (
                        ...
                        >
                            <div className="relative">
                                <img
                                    src="/Keyframez.png"
                                    alt="Keyframez"
                                    className="w-12 h-12 sm:w-24 sm:h-24 object-contain transition-all duration-500
                                    "
                                // group-hover:scale-110 group-hover:rotate-2
                                />
                                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/0 to-purple-600/0  rounded-xl transition-all duration-500" />
                            </div>
        ...
        ${isActivePath("/services")
                            ...
                            {/* Dropdown */}
                            <div
                                className={`dropdown-menu pointer-events-auto absolute top-full left-0 mt-0 w-96 bg-white/95 backdrop-blur-xl
        border border-gray-200/80 shadow-2xl rounded-2xl origin-top-left overflow-hidden
        ${isDropdownOpen ? "block" : "hidden"}`}
                    ...
                    <button
                        className="md:hidden relative w-10 h-10 flex items-center justify-center rounded-xl bg-gray-50/80 hover:bg-gray-100/80 transition-all duration-300 group"
