...
import { Play, Pause, Volume2, VolumeX, BookOpen, Zap, Eye, Sparkles, ArrowRight } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const InteractiveEBooks = () => {
  ...
  useEffect(() => {
    ...
    tl.fromTo('.ebook-content',
      { opacity: 0, x: -50 },
      { opacity: 1, x: 0, duration: 1, ease: "power3.out" }
    );

    tl.fromTo('.ebook-video',
  ...
  const features = [
    { icon: <BookOpen className="w-5 h-5" />, text: "Multimedia Integration" },
    { icon: <Zap className="w-5 h-5" />, text: "Interactive Elements" },
    { icon: <Eye className="w-5 h-5" />, text: "Animations & Videos" },
    { icon: <Sparkles className="w-5 h-5" />, text: "Cross-Platform" }
  ];
    ...
    <section ref={sectionRef} className="py-2 bg-white">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 " style={{
        ...
        <div className="grid lg:grid-cols-2 gap-32 items-center max-w-7xl mx-auto py-20">
          ...
          {/* Left Content */}
          <div className="ebook-content space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-white leading-relaxed">
                Transform reading into an engaging, multimedia experience with our Interactive E-Book solutions. 
                We design and develop dynamic digital books that go beyond text — combining animations, videos, 
                sound effects, quizzes, and interactive elements to keep readers captivated from start to finish.
              </p>

              <p className="text-lg text-white leading-relaxed">
                Perfect for education, training, storytelling, and marketing, our interactive e-books turn 
                static content into immersive journeys that inform, entertain, and inspire. With responsive 
                design and cross-platform compatibility, we ensure a seamless experience on any device.
              </p>

              <p className="text-lg text-white leading-relaxed">
                Bring your stories and ideas to life through interactive e-books that educate, engage, and delight your audience.
              </p>
            </div>
          ...
          {/* Right Video Section */}
          <div className="ebook-video relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <video
                ...
                playsInline
              >
                <source src="/videos/interactive-ebook-demo.mp4" type="video/mp4" />
            ...
            <div className="flex items-center sm:gap-4 bg-white/95 backdrop-blur-xl sm:px-6 sm:py-4 py-2 rounded-2xl shadow-lg border border-gray-200/80 hover:shadow-xl transition-all duration-500 hover:scale-105 w-fit">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-0.5">190+ interactive e-books created</p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Ready to explore more interactive stories?
            </h2>
            ...
            <button className="group w-fit bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              <div className="flex items-center justify-center gap-3">
                <span>View E-Book Portfolio</span>
      ...
      <InteractiveEBookWorkShowcase />
    </section>
  );
};

const InteractiveEBookWorkShowcase = () => {
  const sectionRef = useRef(null);
  ...
  const workVideos = [
    {
      ...
      category: "Learning E-Book",
      videoUrl: "/videos/educational-ebook.mp4"
    },
    {
      id: 2,
      title: "Corporate Training",
      category: "Training E-Book",
      videoUrl: "/videos/corporate-training-ebook.mp4"
    },
    {
      id: 3,
      title: "Children's Stories",
      category: "Storytelling E-Book",
      videoUrl: "/videos/children-stories-ebook.mp4"
    },
    {
      id: 4,
      title: "Product Catalog",
      category: "Marketing E-Book",
      videoUrl: "/videos/product-catalog-ebook.mp4"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Interactive E-Books <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Portfolio</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore our collection of dynamic digital books that transform reading into immersive multimedia experiences.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Let's create interactive e-books that turn static content into captivating multimedia journeys.
            </p>
...
export default InteractiveEBooks;