  ...
  return (
    <section className=" bg-zinc-950 text-white overflow-hidden sm:mt-20">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        {/* Parent: Fluid w-full for mobile, max-w-5xl for desktop impact, mx-auto to center */}
<div className="product-apps-video relative group w-full max-w-5xl mx-auto px-4 lg:-mt-40">
  
  {/* Ambient Glow: Responsive blur and radius to match the main container */}
  ...
  {/* Main Container: Removed md:h-72. aspect-video handles height based on width. */}
  <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl bg-black border border-white/10">
    ...
    {/* <div className="absolute bottom-6 left-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
        <span className="text-white/70 text-[10px] uppercase tracking-[0.3em] font-bold">3D Character Showcase</span>
    </div> */}
  </div>

  {/* Floating Badge: Responsive positioning and visibility */}
  <div className="absolute -top-4 -right-2 sm:-top-8 sm:-right-8 hidden xs:flex animate-bounce-slow z-10">
