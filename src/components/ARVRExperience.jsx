      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center py-20">
          ...
          <div className="product-apps-content space-y-10">
            <div className="space-y-6">
              {/* <div className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-900/50 border border-zinc-800 rounded-full backdrop-blur-md">
                ...
                <span className="text-3xl font-semibold tracking-wide uppercase text-zinc-300">AR & VR Experiences</span>
              </div> */}
              ...
              <p className="text-lg text-zinc-400 leading-relaxed">
                Step into the future of storytelling with our Augmented Reality (AR) and Virtual Reality (VR) Experiences. We create immersive, interactive worlds that blur the line between imagination and reality — allowing your audience to see, feel, and engage with your ideas like never before.
              </p>

              <p className="text-lg text-zinc-400 leading-relaxed">
                From virtual product showcases and architectural walkthroughs to training simulations and brand activations, our AR & VR solutions combine creativity, cutting-edge technology, and seamless design to deliver unforgettable experiences.
              </p>
              <p className="text-lg text-zinc-400 leading-relaxed">
                Whether it’s for marketing, education, entertainment, or visualization, we help brands and creators unlock new dimensions of engagement through powerful, future-ready immersive content.
              </p>
          ...
          <div className="product-apps-video relative group w-full max-w-5xl mx-auto px-4 lg:-mt-40">
            ...
            {/* Main Container: aspect-video handles height fluidly based on width */}
            <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl bg-black border border-white/10">
              <video
                ref={videoRef}
                className="w-full h-full object-cover scale-[1.01]"
                src='https://res.cloudinary.com/dq3ubcgdd/video/upload/v1764438790/AR_VR_Experiences_-_Multi_Loop_uwsjyu.mp4'
                muted={isMuted}
                autoPlay
                loop
                playsInline
        ...
        <span className="text-white/70 text-[10px] uppercase tracking-[0.3em] font-bold">Immersive VR Visualization</span>
    </div> */}
            </div>

            {/* Floating Badge: Responsive visibility */}
