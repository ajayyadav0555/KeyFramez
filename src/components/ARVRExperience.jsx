...
import { Play, Pause, Volume2, VolumeX, Glasses, Zap, Eye, Sparkles, ArrowRight } from 'lucide-react';
...
const ARVRExperiences = () => {
  ...
  useEffect(() => {
    ...
    tl.fromTo('.arvr-content',
      { opacity: 0, x: -50 },
      { opacity: 1, x: 0, duration: 1, ease: "power3.out" }
    );

    tl.fromTo('.arvr-video',
  ...
  const features = [
    { icon: <Glasses className="w-5 h-5" />, text: "Immersive Worlds" },
    { icon: <Zap className="w-5 h-5" />, text: "Interactive Elements" },
    { icon: <Eye className="w-5 h-5" />, text: "Real-time Rendering" },
    { icon: <Sparkles className="w-5 h-5" />, text: "Future-ready Technology" }
  ];
    ...
    <section ref={sectionRef} className="py-2 bg-white">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 " style={{
        ...
        <div className="grid lg:grid-cols-2 gap-32 items-center max-w-7xl mx-auto py-20">
          ...
          {/* Left Content */}
          <div className="arvr-content space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-white leading-relaxed">
                Step into the future of storytelling with our Augmented Reality (AR) and Virtual Reality (VR) Experiences. 
                We create immersive, interactive worlds that blur the line between imagination and reality — allowing your 
                audience to see, feel, and engage with your ideas like never before.
              </p>

              <p className="text-lg text-white leading-relaxed">
                From virtual product showcases and architectural walkthroughs to training simulations and brand activations, 
                our AR & VR solutions combine creativity, cutting-edge technology, and seamless design to deliver unforgettable experiences.
              </p>

              <p className="text-lg text-white leading-relaxed">
                Whether it's for marketing, education, entertainment, or visualization, we help brands and creators unlock 
                new dimensions of engagement through powerful, future-ready immersive content.
              </p>
            </div>
          ...
          {/* Right Video Section */}
          <div className="arvr-video relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <video
                ...
                playsInline
              >
                <source src="/videos/arvr-experience-demo.mp4" type="video/mp4" />
            ...
            <div className="flex items-center sm:gap-4 bg-white/95 backdrop-blur-xl sm:px-6 sm:py-4 py-2 rounded-2xl shadow-lg border border-gray-200/80 hover:shadow-xl transition-all duration-500 hover:scale-105 w-fit">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-0.5">175+ immersive experiences created</p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Ready to experience more immersive worlds?
            </h2>
            ...
            <button className="group w-fit bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
              <div className="flex items-center justify-center gap-3">
                <span>View AR/VR Portfolio</span>
  ...
  const workVideos = [
    {
      ...
      videoUrl: "/videos/virtual-showroom.mp4",
      description: "Interactive product visualization in augmented reality"
    },
    {
      id: 2,
      title: "Architectural VR Tour",
      category: "VR Experience",
      videoUrl: "/videos/architectural-vr-tour.mp4",
      description: "Immersive building walkthroughs in virtual reality"
    },
    {
      id: 3,
      title: "Training Simulation",
      category: "VR Training",
      videoUrl: "/videos/training-simulation.mp4",
      description: "Realistic training scenarios in virtual environments"
    },
    {
      id: 4,
      title: "Brand Activation Experience",
      category: "AR Marketing",
      videoUrl: "/videos/brand-activation.mp4",
      description: "Interactive brand experiences through augmented reality"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            AR & VR Experiences <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Portfolio</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Explore our collection of immersive AR and VR experiences that blur the line between imagination and reality.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            <h3 className="text-3xl font-bold mb-4">
              Ready to Step Into Immersive Worlds?
            </h3>
            <p className="text-xl mb-8 opacity-90">
              Let's create unforgettable AR and VR experiences that transform how your audience engages with your brand.
            </p>
