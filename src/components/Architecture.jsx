    ...
    <>
      <section ref={sectionRef} className="bg-zinc-950 text-white overflow-hidden py-24 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {/* Parent: Fluid w-full for mobile + max-w-5xl (1024px) for desktop impact */}
<div className="hero-video-container relative group w-full max-w-5xl mx-auto px-4 lg:-mt-20">
  
  {/* Glow Effect: Matches the Architectural theme with a clean Cyan/Indigo glow */}
  ...
  {/* aspect-video creates the perfect 16:9 container automatically */}
  <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl bg-black border border-white/10">
    ...
    <div className="absolute bottom-6 left-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-2 group-hover:translate-y-0">
        <span className="text-white/60 text-[10px] uppercase tracking-[0.3em] font-bold">3D Architecture Assets</span>
    </div>
  </div>

  {/* Floating Badge: Responsive visibility for mobile and desktop */}
