...
import {
  Play, Pause, Volume2, VolumeX, Sparkles, FileText, Target, Users, Camera, ArrowRight, PenTool,
  Lightbulb,
              ...
              <div className="grid grid-cols-2 gap-4">
                {features.map((feature, index) => (
                  <div key={index} className="feature-card group p-4 rounded-2xl bg-zinc-900/40 border border-white/5 hover:bg-zinc-800/60 hover:border-purple-500/30 transition-all duration-300">
                    <div className="mb-3 p-2 w-fit rounded-lg bg-gradient-to-br from-purple-500/10 to-blue-500/10 text-purple-400 group-hover:text-purple-300 group-hover:scale-110 transition-transform duration-300">
                      {feature.icon}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-8 flex flex-wrap justify-center md:justify-between items-center gap-6">
            ...
            <div className="group flex items-center gap-4 bg-zinc-950/50 px-6 py-3 rounded-2xl border border-white/5 hover:border-purple-500/20 transition-colors">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-400"><span className="text-white font-bold">4.8/5</span> from 300+ clients</p>
              </div>
            </div>

            <div className="hidden md:flex items-center gap-8 text-zinc-500 text-sm font-medium">
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-purple-500" /> Startups & SaaS</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-purple-500" /> Product Demos</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="w-4 h-4 text-purple-500" /> E-Learning</span>
            </div>
          </div>
        </div>
