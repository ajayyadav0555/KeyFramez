...
import { Play, Pause, Volume2, VolumeX, Sparkles, FileText, Target, Users, Lightbulb, BookOpen } from 'lucide-react';
...
const ExplainerVideos = () => {
  ...
  useEffect(() => {
    ...
    tl.fromTo('.explainer-content',
      { opacity: 0, x: -50 },
      { opacity: 1, x: 0, duration: 1, ease: "power3.out" }
    );

    tl.fromTo('.explainer-video',
  ...
  const features = [
    { icon: <FileText className="w-5 h-5" />, text: "Script to Storyboard" },
    { icon: <Sparkles className="w-5 h-5" />, text: "Motion Graphics" },
    { icon: <Target className="w-5 h-5" />, text: "Clear Communication" },
    { icon: <Users className="w-5 h-5" />, text: "Creative Storytelling" }
  ];
    ...
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Left Content */}
          <div className="explainer-content space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                We craft visually appealing, easy-to-understand videos that help your audience grasp 
                your message in seconds. From script to storyboard, animation to voiceover, we handle 
                the complete production process to ensure your brand stands out.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {services.map((service, index) => (
                  <div key={index} className="service-feature flex items-center gap-3 p-3 bg-white/80 rounded-xl hover:bg-purple-50 transition-all duration-300 hover:scale-105">
            ...
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3 p-4 bg-white/80 rounded-2xl border border-purple-100 hover:shadow-lg transition-all duration-300">
            ...
            <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-2xl font-bold hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
              Get Your Explainer Video
            </button>
          </div>

          {/* Right Video Section */}
          <div className="explainer-video relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <video
                ...
                playsInline
              >
                <source src="/videos/explainer-demo.mp4" type="video/mp4" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Explainer Video <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Portfolio</span>
          </h2>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12 text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Let's create an explainer video that turns your complex ideas into engaging stories.
            </p>
