          ...
          <div className="grid  gap-12">
            ...
            <div ref={founderRef} className="max-w-7xl mx-auto px-6 py-24 md:py-32 bg-gray-50">
              <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-20">
                ...
                {/* LEFT — FOUNDER IMAGE */}
                <div className="relative w-full h-96 lg:h-[920px] rounded-3xl overflow-hidden shadow-2xl shadow-blue-200/50 transform transition-all duration-700 hover:scale-[1.01] hover:shadow-blue-300/70">
                  <div
                ...
                >
                  ...
                  <div className="space-y-6 text-gray-700 text-lg leading-relaxed">
                    <p>
                      <strong className="text-gray-900 font-semibold">Mr. Hari Sudhakaran</strong> , the Founder of Keyframez, is an accomplished professional with over 30 years of experience spanning animation, design, and advanced technology.
                    </p>
