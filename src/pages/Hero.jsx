            ...
            `,
                ...
                <div className="absolute inset-0 pointer-events-none overflow-hidden">
                    ...
                    >
                        <svg viewBox="0 0 100 100">
                            <path fill="#8B5CF6" d="M50 10 Q60 40 90 50 Q60 60 50 90 Q40 60 10 50 Q40 40 50 10Z" />
                        </svg>

                    </svg>
                    <svg
                        className="floating-shape absolute top-20 left-20 w-32 h-32 opacity-30"
                        viewBox="0 0 200 200"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <svg viewBox="0 0 100 100">
                ...
                <div className="hero-content relative z-20 max-w-6xl text-center px-6 lg:px-8">
                    ...
                    >
                        ...
                        Transform your imagination into motion with powerful storytelling, stunning visuals, and immersive digital experiences.
                    </p>

                    {/* Studio Introduction */}
                    {/* <div className="hero-subtitle text-base md:text-lg text-white font-semibold max-w-2xl mx-auto mb-12 leading-relaxed">
                        Welcome to <strong className="text-purple-300 font-bold">KEYFRAMEZ </strong> 
                        a full-service animation and video production studio that turns ideas into visually striking stories. From <span className="text-purple-300 font-bold">corporate videos and explainer films to 3D simulations, AR/VR experiences, and e-learning content</span>, we help brands educate, inspire, and connect with audiences.
                        Our work blends creativity, strategy, and technology. Our mission is simple — to make your ideas unforgettable.
