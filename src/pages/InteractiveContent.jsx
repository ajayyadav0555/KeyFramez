    ...
    <>
      <div ref={containerRef} className="bg-zinc-950 text-white overflow-hidden selection:bg-pink-500/30">
        ...
        <section className="relative py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          {/* Parent: w-full for mobile, max-w-5xl for a large 'Hero' impact on desktop */}
<div className="hero-video-container relative group w-full max-w-5xl mx-auto px-4 lg:-mt-40">
  
  {/* Glow Effect: Uses responsive blur and rounded values */}
  ...
  {/* Container: aspect-video is the key to responsive height */}
  <div className="relative rounded-[2rem] overflow-hidden aspect-video shadow-2xl bg-black border border-white/10">
    ...
    {/* Optional: Add hover-only info badge for extra "Modern" feel */}
    <div className="absolute bottom-6 left-6 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
        <span className="text-white/70 text-xs uppercase tracking-widest font-medium">Interactive Modules</span>
    </div>
  </div>
  ...
  <div className="absolute -top-4 -right-2 sm:-top-8 sm:-right-8 hidden xs:flex animate-bounce-slow">
    <div className="bg-zinc-900/90 backdrop-blur-md border border-zinc-700 text-white px-4 py-2 sm:px-5 sm:py-3 rounded-2xl shadow-xl flex items-center gap-3">
      ...
      <span className="font-semibold text-xs sm:text-sm tracking-tight">Real-Time Graphics</span>
    </div>
  </div>
</div>
          </div>
