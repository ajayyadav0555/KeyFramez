...
import { Play, Pause, Volume2, VolumeX, BookOpen, Monitor, Target, Zap, ArrowRight } from 'lucide-react';
...
const LMSLearningContent = () => {
  ...
  const features = [
    ...
    { icon: <BookOpen className="w-5 h-5" />, text: "Gamified Learning" }
  ];
            ...
            <div className="flex items-center sm:gap-4 bg-white/95 backdrop-blur-xl sm:px-6 sm:py-4 py-2 rounded-2xl shadow-lg border border-gray-200/80 hover:shadow-xl transition-all duration-500 hover:scale-105 w-fit">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-0.5">220+ e-learning modules created</p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col justify-center space-y-6">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
              Ready to explore more learning modules?
            </h2>
